...
public class RedisDAO {
    ...
    private RuntimeSchema<Seckill> schema = MySchema.GetSchema(Seckill.class);
    ...
    public void setAllGoods(List<Seckill> list) {
        ...
        for (Seckill seckill : list) {
            ...
            byte[] goodsBytes = ProtostuffIOUtil.toByteArray(seckill,MySchema.GetSchema(Seckill.class),LinkedBuffer.allocate(LinkedBuffer.DEFAULT_BUFFER_SIZE));
